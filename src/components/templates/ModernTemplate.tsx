  ...
  return (
    <div className="flex bg-white max-w-[800px] mx-auto shadow-2xl min-h-[1100px] font-sans overflow-hidden">
      ...
      <div className="w-[280px] bg-slate-900 text-white p-10 flex flex-col">
        <div className="mb-10">
          <div className="w-32 h-32 bg-blue-600 rounded-full mx-auto mb-6 flex items-center justify-center text-4xl font-black">
          ...
          <p className="text-blue-400 text-xs font-bold text-center uppercase tracking-widest">
            {data.profile.title}
          </p>
        </div>
          ...
          <section>
            ...
            <div className="space-y-5">
              {data.education.map((edu, i) => (
                <div key={i}>
                  <div className="text-[11px] font-black text-blue-400 mb-1">{edu.year}</div>
      ...
      <div className="flex-grow p-12 bg-slate-50 flex flex-col">
        <section className="mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-100 rounded-lg text-blue-700 text-[10px] font-black uppercase tracking-widest mb-4">
            Profil
          </div>
        ...
        <section className="flex-grow">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-100 rounded-lg text-blue-700 text-[10px] font-black uppercase tracking-widest mb-8">
            Expériences
          </div>
          <div className="space-y-10">
            {data.experiences.map((exp, i) => (
              <div key={i} className="relative pl-8 border-l border-slate-200">
                <div className="absolute -left-[5px] top-0 w-2.5 h-2.5 rounded-full bg-blue-600 border-2 border-white shadow-sm" />
