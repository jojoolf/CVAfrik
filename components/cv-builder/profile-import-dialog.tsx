...
export function ProfileImportDialog({ currentData, onApply, disabled }: ProfileImportDialogProps) {
  ...
  const modes: { id: ImportMode; label: string; icon: typeof Linkedin; note: string }[] = [
    { id: 'linkedin', label: 'Export LinkedIn', icon: Linkedin, note: 'Importe ton archive personnelle LinkedIn (.zip).' },
    { id: 'text', label: 'Coller mon profil', icon: ClipboardPaste, note: 'Copie le texte de ton profil ou de ton CV.' },
    { id: 'pdf', label: 'PDF / CV', icon: FileText, note: 'Analyse PDF bientôt disponible.' },
  ]
